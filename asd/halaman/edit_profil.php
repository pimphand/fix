  ...
  <div class="clearfix"></div>
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
        <form id="demo-form2" method="post" data-parsley-validate class="form-horizontal form-label-left" action="proses/edit_profil.php" enctype="multipart/form-data">
          <div class="x_title">
          ...
          <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
              ...
              <center>
                <div id="crop-avatar">
                <!-- Current avatar 
                  <img class="img-responsive avatar-view" src="images/profil/<?php echo $dAnggota['gambar'] ?>" alt="Avatar">
                  <br>
